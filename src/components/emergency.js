...
<div className="hov d-flex flex-wrap">
  ...
  <Card.Body>
    ...
    <Card.Text>
     Sponsor an Internally displaced person to learn a trade or Emergency to our project aimed at training women and girls on how to make sandals and bags using beads.
    </Card.Text>
    <Button className="font-weight-bold bg-dark"> <Nav.Item>
